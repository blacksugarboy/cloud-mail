const en = {
    ...
    addEmailWithoutCodeHint: 'Without a code: multiple email mode and Add Email Address must be enabled; your role limit still applies.',
    addEmailWithCodeHint: 'With a code: a valid default-role code bypasses Add Email Address, but not multiple email mode or your role limit.',
    addEmailDisabledCodeHint: 'An invite code is currently required to add an email address.',
    emailAccount: 'Email',
    account: 'Address',
    ...
    tabRole: 'Role',
    roleName: 'Name',
    roleAccountLimitHint: 'Maximum bound addresses, including the primary address (0 means unlimited)',
    role: 'Name',
    all: 'All',
    normal: 'Normal',
    banned: 'Banned',
    ...
    accountCount: 'Addresses : ',
    accountUsage: '{current}/{limit}',
    addDisabled: 'Adding disabled',
    inviteCodeOnly: 'Code only',
    action: 'Action',
    chgPwd: 'Password',
    perm: 'Role',
    btnBan: 'Ban',
    ...
    registeredUserValidity: 'Registered User Validity',
    changeValidity: 'Change Validity',
    ...
    oneYear: 'One Year',
    permanent: 'Permanent',
    emptyValidityRange: 'Select a validity date range',
    expired: 'Expired',
    copy: 'Copy',
    copyAll: 'Copy All',
    history: 'History',
    addRegKey: 'Add Invite Code',
    singleRegKey: 'Single Code',
    batchRegKey: 'Batch One-Time Codes',
    availableUses: 'Uses allowed for this code',
    batchQuantity: 'Number of codes',
    batchOneTimeHint: 'Generates different invite codes that can each be used once, up to 200 per batch.',
    batchResultTitle: 'Generated Invite Codes',
    batchAddSuccessMsg: 'Generated {count} one-time invite codes',
    emptyBatchCountMsg: 'Number of codes cannot be empty',
    generate: 'Generate',
    regKey: 'Invite Code',
    ...
    multipleEmailDesc: 'Enable role-based address limits. When disabled, existing addresses remain available but no new address can be added',
    addEmailSettingDesc: 'Controls adding without an invite code. A valid code for the default role can bypass this setting, but not disabled multiple email mode',
    ...
    manyEmailAddDisabledMsg: 'Multiple email mode is disabled. Existing addresses remain available, but no new address can be added',
    addEmailDisabledCodeMsg: 'Adding email addresses is disabled. Enter a valid invite code for the default role and try again',
