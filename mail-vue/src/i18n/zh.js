const zh = {
    ...
    addAccount: '添加邮箱',
    addEmailWithoutCodeHint: '不使用注册码：需开启多号模式及“添加邮箱”，并受当前身份邮箱数量上限限制。',
    addEmailWithCodeHint: '使用注册码：默认权限身份的有效注册码可绕过“添加邮箱”，仍受多号模式及数量上限限制。',
    addEmailDisabledCodeHint: '当前仅支持使用注册码添加邮箱。',
    emailAccount: '邮箱',
    account: '邮箱',
    userAccount: '用户邮箱',
    deleteUser: '删除账户',
    ...
    tabRole: '权限身份',
    roleName: '名字',
    roleAccountLimitHint: '可绑定邮箱总数上限（包含主邮箱，0 表示不限制）',
    role: '权限身份',
    all: '全部',
    normal: '正常',
    banned: '封禁',
    ...
    validFrom: '有效开始时间',
    userValidity: '用户有效期',
    registeredUserValidity: '注册用户有效期',
    changeValidity: '修改有效期',
    presetDuration: '按时长',
    dateRange: '日期范围',
    oneWeek: '一周',
    oneMonth: '一个月',
    ...
    addRegKey: '添加注册码',
    singleRegKey: '单个注册码',
    batchRegKey: '批量一次性注册码',
    availableUses: '该注册码可使用次数',
    batchQuantity: '生成数量',
    batchOneTimeHint: '将生成多个不同的注册码，每个注册码只能使用一次，单次最多生成 200 个。',
    batchResultTitle: '批量生成结果',
    batchAddSuccessMsg: '已生成 {count} 个一次性注册码',
    emptyBatchCountMsg: '生成数量不能为空',
    generate: '生成',
    regKey: '注册码',
    noCodeFound: '没有任何注册码',
    useHistory: '使用记录',
    ...
    loginDomain: '隐藏登录域名',
    multipleEmail: '多号模式',
    multipleEmailDesc: '开启后可按权限身份限制邮箱数量；关闭后已有邮箱仍可使用，但不能继续添加',
    addEmailSettingDesc: '控制不使用注册码的添加方式；关闭后仍可使用默认权限身份的有效注册码添加，多号模式关闭时则一律禁止新增',
    customization: '个性化设置',
    websiteTitle: '网站标题',
    ...
    manyEmailAddDisabledMsg: '多号模式已关闭，已有邮箱可继续使用，但不能添加新邮箱',
    addEmailDisabledCodeMsg: '添加邮箱功能已关闭，请填写默认权限身份的有效注册码后重试',
    regSuccessMsg: '注册成功',
    copySuccessMsg: '复制成功',
    copyFailMsg: '复制失败',
