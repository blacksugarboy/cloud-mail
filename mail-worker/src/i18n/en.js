const en = {
	...
	addAccountDisabled: 'Adding email addresses is disabled; you can still use a valid invite code for the default role',
	manyAccountDisabled: 'Multiple email mode is disabled. Existing addresses remain available, but no new address can be added',
	...
	accountRegKeyDefaultRoleOnly: 'Only invite codes assigned to the default role can be used to add an email address',
	...
	invalidUserValidity: 'This user is outside the valid period and cannot sign in or use the system',
	invalidValidityType: 'Invalid user validity type',
	invalidValidityRange: 'Invalid validity date range',
	adminValidityPermanent: 'The super administrator is permanently valid',
	cannotSetOwnValidity: 'You cannot change your own validity period',
	cannotSetValidityPeer: 'You cannot change the validity period of another user with this permission',
	regKeyUseCount: 'Usage count cannot be empty',
	batchRegKeyCountRange: 'Batch quantity must be between 1 and {{max}}',
	...
	invalidAccountCount: 'The email address limit must be an integer between 0 and 99999',
