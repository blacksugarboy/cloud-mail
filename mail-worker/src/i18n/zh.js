const zh = {
	IncorrectPwd: '密码输入错误',
	addAccountDisabled: '添加邮箱功能已关闭；你仍可使用默认权限身份的有效注册码添加邮箱',
	manyAccountDisabled: '多号模式已关闭，已有邮箱可继续使用，但不能添加新邮箱',
	regDisabled: '注册功能已关闭',
	emptyEmail: '邮箱不能为空',
	notEmail: '非法邮箱',
	...
	accountRegKeyDefaultRoleOnly: '添加邮箱仅支持默认权限身份的注册码',
	...
	isDelUser: '该邮箱已被注销',
	isBanUser: '该邮箱已被禁用',
	invalidUserValidity: '用户不在有效期内，无法登录或使用系统',
	invalidValidityType: '无效的用户有效期类型',
	invalidValidityRange: '有效期日期范围无效',
	adminValidityPermanent: '超级管理员有效期固定为永久',
	cannotSetOwnValidity: '不能修改自己的有效期',
	cannotSetValidityPeer: '不能修改同样具有有效期修改权限的用户',
	regKeyUseCount: '使用次数不能为空',
	batchRegKeyCountRange: '批量生成数量必须为1到{{max}}',
	emptyRegKeyExpire: '有效时间不能为空',
	isExistRegKye: '注册码已存在',
	roleNotExist: '权限身份不存在',
	emptyRoleName: '身份名不能为空',
	invalidAccountCount: '可绑定邮箱数量必须为0到99999之间的整数',
